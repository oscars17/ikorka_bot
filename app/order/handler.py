...
class OrderHandler:
    ...
    async def handle_contact(self, message: Message, state: FSMContext) -> None:
        ...
        text = (
            ...
            "\n"
            '🎄 НАБОР "НОВОГОДНИЙ": \n'
            "➤  Икра 500 г     <s>4 000 ₽</s> → 3 800 ₽ (-200 ₽)\n"
            "➤  Краб 600 г     <s>4 500 ₽</s> → 4 300 ₽ (-200 ₽)\n"
            "➤  Креветка 800 г <s>3 800 ₽</s> → 3 600 ₽ (-200 ₽)\n"
            "➤  Гребешок 500 г <s>2 300 ₽</s> → 2 200 ₽ (-100 ₽)\n"
            "\n"
            "Цена набора <s>14 600 ₽</s> → 13 900 ₽ (-700 ₽)\n"
        )
        await message.answer(
            text,
            reply_markup=ReplyKeyboardRemove(),

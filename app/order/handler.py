...
class OrderHandler:
    ...
    async def handle_contact(self, message: Message, state: FSMContext) -> None:
        ...
        text = (
            ...
            "➤  1 кг — 4 500 ₽ \n"
            "\n"
            "🎄 Новогодний набор \"Для всех\" за 1 упаковку:\n"
            "➤ Икра 500 г     ~~4 000 ₽~~ → 3 800 ₽ (-200 ₽)\n"
            "➤ Краб 600 г     ~~4 500 ₽~~ → 4 300 ₽ (-200 ₽)\n"
            "➤ Креветка 800 г ~~3 800 ₽~~ → 3 600 ₽ (-200 ₽)\n"
            "➤ Гребешок 500 г ~~2 300 ₽~~ → 2 200 ₽ (-100 ₽)\n"
            "\n"
            "Цена набора ~~14 600 ₽~~ → 13 900 ₽ (-700 ₽)\n"
        )
        await message.answer(
            text,
            reply_markup=ReplyKeyboardRemove(),
